...
import { AddApiKeysForCommunity1765940000000 } from './migration/postgres/1765940000000-AddApiKeysForCommunity'
...
export const getMigrations = (): (new () => MigrationInterface)[] => {
    const migrations = [
        ...
        // OruCRM: Add API keys support for Community Edition
        AddApiKeysForCommunity1765940000000,
    ]
    return migrations
}
